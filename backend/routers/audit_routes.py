...
from core import db, require_roles, ROLE_CEO, ROLE_ADMIN
...
async def list_audit(
    user: dict = Depends(require_roles(ROLE_CEO, ROLE_ADMIN)),
...
async def list_audit_actions(user: dict = Depends(require_roles(ROLE_CEO, ROLE_ADMIN))):
