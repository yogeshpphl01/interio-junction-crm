...
from core import (
    db, require_roles, NotificationSettingsInput, TestEmailInput, ROLE_CEO, ROLE_ADMIN,
)
...
async def get_notification_settings(user: dict = Depends(require_roles(ROLE_CEO, ROLE_ADMIN))):
    return await _get_settings(user)


@router.post("/notifications/settings")
async def save_notification_settings(payload: NotificationSettingsInput, user: dict = Depends(require_roles(ROLE_CEO, ROLE_ADMIN))):
...
async def send_test_notification(payload: TestEmailInput, user: dict = Depends(require_roles(ROLE_CEO, ROLE_ADMIN))):
