...
/// Loads a future, shows spinner/error/empty, and wires pull-to-refresh. The
/// builder receives the data plus a `refresh` callback it can call after an
/// action (e.g. accepting an estimate) to reload the list.
...
/// A centered empty state that still allows pull-to-refresh.
